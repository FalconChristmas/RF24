...
#ifdef ARDUINO
	#if  ( !defined(RF24_TINY) && !((defined(__arm__) || defined(__aarch64__)) || defined(__aarch64__))  && !defined (SOFTSPI)) || defined (CORE_TEENSY)
...
#elif !(defined(__arm__) || defined(__aarch64__)) || defined (CORE_TEENSY)
	digitalWrite(csn_pin,mode);	
    delayMicroseconds(5);	
#endif
...
#elif ((defined(__arm__) || defined(__aarch64__)) || defined(__aarch64__)) && !defined ( CORE_TEENSY )
...
#if (defined(__arm__) || defined(__aarch64__)) || defined (RF24_LINUX) || defined (__ARDUINO_X86__) || defined(LITTLEWIRE)
...
void RF24::begin(void)
{
  ...
  #if (defined(__arm__) || defined(__aarch64__)) && ! defined( CORE_TEENSY )
...
bool RF24::setDataRate(rf24_datarate_e speed)
{
  ...
  #if (defined(__arm__) || defined(__aarch64__)) || defined (RF24_LINUX) || defined (__ARDUINO_X86__)
    txRxDelay=250;
  #else //16Mhz Arduino
    txRxDelay=85;
  #endif
